...
const StatCard = ({ icon, label, value }) => (
  <Stack alignItems="center" spacing={1}>
    <Avatar sx={{ bgcolor: '#e0f2f1', color: '#198754', width: 40, height: 40 }}>{icon}</Avatar>
...
export default function BlogContentCard({ title = 'Blog Content' }) {
    ...
    <>
      ...
      <Card sx={{ p: 2, mb: 6 }}>
        <Stack direction="row" alignItems="center" spacing={1} sx={{ my: 3 }}>
          <Typography variant="h6">Contextual Blogs</Typography>
        </Stack>
