...
import Sidenavbarpeset from './sidenavbarpreset.jsx';
...
export default function SettingsDrawer() {
  ...
  const renderPresets = (
    <div>
      ...
      <Sidenavbarpeset
        value={settings.newThemeColorPresets}
        onChange={(newBackValue) => settings.onUpdate('newThemeColorPresets', newBackValue)}
      />
